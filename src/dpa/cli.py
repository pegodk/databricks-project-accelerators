...
def init(
    ...
    console.print("[yellow]⚠[/yellow]  Set your workspace URLs in [bold]databricks.yml[/bold] under each target:")
    console.print("     targets:")
    console.print("       dev:")
    console.print("         workspace:")
    console.print("           host: https://<your-dev-workspace-url>")
    console.print("       prod:")
    console.print("         workspace:")
    console.print("           host: https://<your-prod-workspace-url>\n")
